...
# 2. Instalar dependencias esenciales del sistema para PostgreSQL, Git, Zip y librerías de desarrollo gráfico (GD)
...
# 3. Configurar e instalar la extensión de procesamiento gráfico GD junto con PDO Postgres
...
# 5. Habilitar la reescritura de URLs en Apache
RUN a2enmod rewrite

# 6. Traer e instalar Composer de manera global
...
# ---------------------------------------------------------------------------------
# CONFIGURACIÓN DE RENDIMIENTO: Límites extendidos para subidas fluidas
# ---------------------------------------------------------------------------------
